...
description: A comprehensive guide to building a self-hosted AI learning platform
  that generates personalized lessons, quizzes, and coding challenges using local
  LLMs, knowledge graphs, and retrieval-augmented generation.
layout: post
tags:
...
title: 'Building an AI-Driven Personalized Learning Platform: Dynamic Lessons with
  Local LLMs and Knowledge Graphs'
wiki_references: ["docker", "embeddings", "knowledge-graphs", "llama3", "local-inference", "ollama", "python", "rag", "rlhf", "sentence-transformers", "typescript"]
---
