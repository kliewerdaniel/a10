  ...
  Documenting architectures for intelligence you own.
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[{ href: '/', label: 'Home' }, { href: '/book', label: 'The Book' }, { href: '/blog', label: 'Research' }].map((l) => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[{ href: '/projects', label: 'Projects' }, { href: '/blog', label: 'Technical Essays' }, { href: '/about', label: 'About Daniel' }].map((l) => (
                <li key={l.href}><Link href={l.href} className="text-sm text-ink-3 hover:text-ink transition-colors font-bold">{l.label}</Link></li>
              ))}
            </ul>
          </div>
